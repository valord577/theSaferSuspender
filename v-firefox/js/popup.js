...
timeSelect.addEventListener('change', () => {
    ...
    browser.storage.sync.set({mins: _value});
});
...
ctlKey.addEventListener('change', () => {
    ...
    browser.storage.sync.set({ctlKey: _value});
});
...
sftKey.addEventListener('change', () => {
    ...
    browser.storage.sync.set({sftKey: _value});
});
...
cusKey.addEventListener('change', () => {
    ...
    browser.storage.sync.set({cusKey: _value});
});
...
rules.addEventListener('blur', () => {
    ...
    browser.storage.sync.set({rules: _list});
});
